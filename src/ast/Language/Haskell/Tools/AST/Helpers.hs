{-# LANGUAGE ExplicitNamespaces, FlexibleContexts, KindSignatures, MonoLocalBinds, PatternSynonyms, RankNTypes, ScopedTypeVariables, TypeSynonymInstances, UndecidableInstances #-}
